...
- Optimistic Locking mechanisim with @Version is used for concurrency management. We can make use of pessimistic lock with some timeout if there is heavy concurreny or frequent updates maybe during sale
